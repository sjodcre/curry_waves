...
// 			setBanner(props.profile.banner ? props.profile.banner : null);
// 			setAvatar(props.profile.avatar ? props.profile.avatar : null);
// 		}
// 	}, [props.profile]);
...
// 			return {
// 				status: true,
// 				message: `${'Max Characters Reached'} (${bio.length} / ${MAX_BIO_LENGTH})`,
// 			};
// 		}
...
// 		if (banner) return <img src={banner} />;
// 		return (
// 			<>
// 				<Image size={20} />
